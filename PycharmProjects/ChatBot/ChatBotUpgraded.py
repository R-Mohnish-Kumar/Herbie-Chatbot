...
print("Herbie:- Hey there..! I am virtual Bot..I will answer your queries for a while..;)")
print("Herbie:- Before we begin..May I know your good name..?")
client_name=input()
...
print("Herbie:- Hi "+client_name+"..!Nice to see you..How may i help you..?")
...
def leaving_greeting(input):
  ...
  for word in input.split():
    if word in leaving_greeting_by_user:
      return print("Herbie:-"+random.choice(leaving_greeting_by_bot))
